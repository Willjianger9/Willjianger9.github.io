      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          {experiences.map((experience, index) => (
            ...
            >
              <div className="absolute left-[8px] md:left-[8px] w-[20px] h-[20px] rounded-full bg-gradient-to-r from-blue-400 to-purple-500 border-4 border-black/50 opacity-0 timeline-dot" />
              
              <div className="flex-1 ml-[40px] md:ml-[60px] opacity-0 content-container">
        ...
        <div className="relative">
          ...
          {research.map((researchItem, index) => (
            <div
              ...
              className="relative flex flex-col md:flex-row gap-8 mb-12 experience-item"
            >
              <div className="absolute left-[8px] md:left-[8px] w-[20px] h-[20px] rounded-full bg-gradient-to-r from-green-400 to-teal-500 border-4 border-black/50 opacity-0 timeline-dot" />
